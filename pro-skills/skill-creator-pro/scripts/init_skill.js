...
function renderSkillMd(name) {
    ...
    return [
        ...
        '## Known-good run',
        '',
        '[TODO: After the dry-run, record one trigger phrase and the expected',
        'end state, so future runs and edits have a baseline. Delete if unused.]',
        '',
        '## Known gotchas',
        '',
        '[TODO: Concrete failure modes and how to avoid them, not "be careful".',
        'Delete if none surfaced.]',
        '',
    ].join('\n');
}
