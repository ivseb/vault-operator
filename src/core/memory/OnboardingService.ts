...
2. NAMING
   ...
   -> ask_followup_question:
      ...
      options: ["Vault Operator works, lets go", "I have an idea..."]
...
6. TONE
   ...
   -> ask_followup_question:
      ...
      options:
        ...
        - "Technical and precise, details matter"
...
7. PERMISSIONS
   ...
   -> ask_followup_question:
      ...
      options:
        ...
        - "Cautious, ask me before every action"
...
1. ALWAYS WRITE TEXT FIRST, THEN CALL THE TOOL.
   ...
   piece of context.
   WRONG: "I'm Vault Operator... What should I call you?"
