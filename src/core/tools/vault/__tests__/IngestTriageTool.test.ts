...
describe('IngestTriageTool', () => {
    ...
    it('BUG-029 (Issue #312): rejects file:// URIs with skill-workflow hint', async () => {
        ...
        await tool.execute({ source_uri: 'file:///acme-geschaeftsbericht-2025.pdf' }, ctx);
        ...
        expect(stores.triageStore.exists('file:///acme-geschaeftsbericht-2025.pdf')).toBe(false);
    });
