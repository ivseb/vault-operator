...
export class EsbuildWasmManager {
    ...
    private loadCommonJsModule(jsCode: string): EsbuildModule {
        ...
        // eslint-disable-next-line @typescript-eslint/no-implied-eval -- required to load esbuild-wasm JS bundle at runtime; jsCode is fetched from a trusted CDN (esm.sh/jsdelivr), not user input
