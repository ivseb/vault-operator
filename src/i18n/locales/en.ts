...
export const en: Translations = {
    ...
    'settings.embeddings.infoStorageBody': '"global" (recommended) stores the index at ~/.obsidian-agent/ outside the vault, so it is not watched. The index contains derived data (embeddings) that can be rebuilt on any device. "sync" stores it inside the plugin folder (can freeze large vaults). "local" stores it at .obsidian-agent/ in the vault root.',
    ...
    'settings.shell.enablePluginApiDesc': "Allow the agent to call JavaScript APIs on installed plugins (queries, search, metadata edits). Runs entirely in the app's JS sandbox.",
    ...
    'guide.ollama.step4': 'Enter the model name exactly as pulled (e.g. llama3.2) into the model ID field above.',
    ...
    'guide.azure.step4': 'In model ID, enter the exact deployment name from the cloud console (e.g. gpt-4o).',
