...
Recipes include a `success_count` that tracks how often they've worked. Low-success recipes get deprioritized. The system is conservative about applying recipes -- it only suggests them when trigger keywords match with high confidence.
