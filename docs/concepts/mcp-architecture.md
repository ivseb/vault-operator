---
title: MCP
description: How Vault Operator acts as both an MCP client and an MCP server, connecting external tools and exposing the vault, memory, and history to other AI surfaces.
---
...
```mermaid
flowchart LR
    E[External MCP servers] -->|tools and resources| O[Vault Operator]
